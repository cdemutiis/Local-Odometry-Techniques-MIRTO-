/* File: JMirtoRobot.java
 * Date: October 2014
 * Middlesex University London
 * Author: Franco Raimondi (F.Raimondi@mdx.ac.uk) and his team
 * Purpose: Provide the MIRTO robot with low-level functionalities
 * to control the wheels' motors and the robot's sensors, i.e. 
 * bumper's sensors and encoders in the wheels.
 * 
 * NOTE: This code has been modified by Claudio S. De Mutiis 
 * (claudio.de_mutiis@kcl.ac.uk) in August 2015. 
